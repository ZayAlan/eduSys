...
public class StoreCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_store_course);
        Toolbar toolbar = findViewById(R.id.toolbar_store_course);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayShowTitleEnabled(false);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        FloatingActionButton floatingActionButton = findViewById(R.id.add_store_course);
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MyUtilities.setKindRole(1); //设置教育机构
                Intent intent = new Intent(StoreCourseActivity.this, AddCourseActivity.class);
                startActivityForResult(intent, 2);
            }
        });
        initCourseList();
        RecyclerView recyclerView = findViewById(R.id.store_course_recyclerView);
    ...
    private Runnable removeRunnable = new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                Toast.makeText(StoreCourseActivity.this, "can't connected!", Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        }
    };
    ...
    private Runnable initCourseRunnable = new Runnable() {
        ...
        public void run() {
            ...
            Gson sendGson = new Gson();
            String jsonData = sendGson.toJson(enterStore);
            RequestBody requestBody = FormBody.create(MediaType.parse("application/json; charset=utf-8"), jsonData);
            Request request = new Request.Builder()
                    .url(MyUtilities.MYURL+"/course/showStoreTimetable")
                    .post(requestBody)
                    .build();
            Response response = null;
            try {
